...
@section('title', 'Daftar Hewan :: '. config('app.name'))
@section('heading', 'Daftar Hewan')
...
<div class="row">
  ...
  <div class="col-md-5">
    <div class="card card-outline card-primary" id="card-submit" style="display: none">
      <div class="card-header">
        <h5 class="card-title" id="card-title">Tambah Hewan</h5>
        <div class="card-tools">
      ...
      <form id="form" enctype="multipart/form-data">
        ...
        <div class="card-body">
          <div class="form-group row">
            <label for="nama" class="col-sm-4 col-form-label">Nama Hewan <span class="text-danger">*</span></label>
            <div class="col-sm-8">
...
<script>
  ...
  document.getElementById('btn-open-card-add').addEventListener('click', function(event) {
    cardTitleFormSubmit.innerHTML = 'Tambah Hewan';
    clearAllInput();
  ...
  function onClickEdit(event) {
    ...
    cardTitleFormSubmit.innerHTML = 'Edit Hewan';
    clearAllInput();
    document.getElementById('id').value = id;
    document.getElementById('_method').value = 'put';

    fetch(`{{ route('hewan.index') }}/${id}/edit`)
      .then(res => res.json())
      .then(data => {
        if (data.status) {
