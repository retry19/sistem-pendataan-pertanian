...
@section('title', 'Laporan Kepemilikan Lahan Pertanian :: '. config('app.name'))
@section('heading', 'Laporan Kepemilikan Lahan Pertanian')

@section('content')
<div class="card">
  <form action="{{ route('laporan.kepemilikan-lahan-pertanian.store') }}" method="POST">
    @csrf
    <div class="card-body">
