...
@section('title', 'Laporan Daftar Dokumentasi :: '. config('app.name'))
@section('heading', 'Laporan Daftar Dokumentasi')

@section('content')
<div class="card">
  <form action="{{ route('laporan.dokumentasi.store') }}" method="POST">
    @csrf
    <div class="card-body">
